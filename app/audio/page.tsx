...
export default function Home() {
  ...
  function toggleTimer() {
    const audio = new Audio("/sounds/536421__rudmer_rotteveel__setting-electronic-timer-multiple-beeps.mp3");
    ...
    <div className="flex bg-slate-800 text-white min-h-screen items-center justify-center p-8 flex-col">
      ...
      <main className="flex flex-col  gap-8 ">
        ...
        <section className="flex gap-16 text-4xl ">
          ...
          <button
            className={` hover:opacity-80 hover:scale-105 transition-all ${disableStartBtn && "cursor-not-allowed"
              }  `}
